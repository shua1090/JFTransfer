...
//            System.out.println(pathBindings);
    ...
    public static void commitChanges(){
        ...
        System.out.println("Unchanged, undeleted/added files:");
        System.out.println(temp);
//        System.out.println(new ArrayList<Path>(pathBindings.keySet()));

        var t = getModifiedFiles(z, temp);

        System.out.println("Of those, these are changed:");
        ...
        System.out.println("Added: "+changed.get(0));
        System.out.println("Deleted: "+changed.get(1));
